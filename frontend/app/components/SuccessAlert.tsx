  ...
  return (
    <Modal visible={visible} transparent animationType="none">
      <View className="flex-1 items-center justify-center bg-black/25 px-6">
        ...
        >
          <View className="w-16 h-16 rounded-full bg-[#F8FE11] items-center justify-center mb-8">
            <Feather name="check" size={34} color="#15000" />
          </View>

          <Text className="text-[#140505] text-[22px] font-bebas uppercase text-center tracking-wide mb-10">
            {message}
          </Text>
        </Animated.View>
      </View>
